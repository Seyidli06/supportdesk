...
- Use a strong and independently generated JWT secret.
- Disable SQL logging.
- Enable TLS.
- Use restricted database credentials.
- Configure trusted reverse-proxy forwarding.
- Do not trust arbitrary `X-Forwarded-For` values.
- Replace direct administrator bootstrap with controlled provisioning.
- Use a distributed rate-limit store for multiple application instances.
